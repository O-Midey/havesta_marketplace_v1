...
const PromoDealsSection = () => {
  ...
  // Add to cart button with hover effect
   const AddToCartButton = ({ onClick, disabled, className }) => { // Modify this line
    return (
      <button
        onClick={onClick}
        disabled={disabled}
  ...
  return (
    <section className="py-8 px-4 sm:px-6 lg:px-8">
      <div className="mb-8">
  <div className="flex items-center gap-3">  {/* <- change here */}
    ...
    <div className="bg-red-600 text-white px-3 py-1 rounded-md text-sm font-medium">
      Expires in: {formatTime(timeLeft.hours)}:{formatTime(timeLeft.minutes)}:{formatTime(timeLeft.seconds)}
    </div>
  </div>
</div>
...
<div className="relative h-48 w-full bg-white-100 overflow-hidden">
  <img
    ...
    style={{ width: '200%', height: '107%', objectFit: 'contain' }}
  />
